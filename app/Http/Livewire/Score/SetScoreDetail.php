...
class SetScoreDetail extends Component{
    ...
    private function addValue(){
        ...
        $this->docente = $scores->docente;
        $this->asignatura = $scores->asignatura;  
    ...
    private function getLetter($value){
        $letra = '';
        if($this->asignatura === "Conducta"){
                               
            switch (true) {
                case ($value >= 90 ): $letra = 'E'; break;
                case ($value >= 80): $letra = 'MB'; break;
                case ($value >= 70): $letra = 'B'; break;
                case ($value >= 60): $letra = 'R'; break;
                default: $letra = 'D';
            } 
        }else{
            switch (true) {
                case ($value >= 90 ): $letra = 'AA'; break;
                case ($value >= 75): $letra = 'AS'; break;
                case ($value >= 60): $letra = 'AE'; break;
                default: $letra = 'AI';
            }
        }
            return $letra;
    ...
    public function especialScore($value){
        
          scores::where('idnotas', $this->idnotas)->update(['especial'=> $value]);
           $this->addValue();
    ...
    public function render(){
        return view('livewire.score.set-score-detail');
    }
